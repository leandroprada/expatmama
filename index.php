							...
							<ul>
								...
								<li data-index="rs-280" data-transition="fade" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default"  data-title="Expat Mama!" data-description="">
									...
									<div class="tp-caption"
										...
										<h1><?php echo $userlogged; ?>, welcome to Expat MAMA!</h1>
									</div>
									...
									<div class="tp-caption"
										...
										data-splitout="none"
										data-responsive_offset="on">
										<a href="./login/login.php" class="project-button hvr-bounce-to-right">View Content!</a>
									</div>
							...
							<ul>
								...
								<li data-index="rs-280" data-transition="fade" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default"  data-title="Expat Mama!" data-description="">
									...
									<div class="tp-caption"
										...
										data-splitout="none"
										data-responsive_offset="on">
										<a href="#about-us" class="project-button hvr-bounce-to-right"> Please Login to View Content!</a>
									</div>
