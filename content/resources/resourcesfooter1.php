...
<footer>
		<div class="container">
			...
			<ul>
				...
				<li><a href="https://www.youtube.com/channel/UCzpP0SPLS2b58SScNw_F7Mg" target="_blank" class="tran3s round-border"><i class="fab fa-youtube" aria-hidden="true"></i></a></li>

			</ul>
			<p>Copyright @2021 All rights reserved | This template is made with <i class="fas fa-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a></p>
